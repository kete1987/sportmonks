...
import es.com.kete1987.sportmonks.library.v2.model.league.LeagueResponse;
import es.com.kete1987.sportmonks.library.v2.model.match.MatchData;
...
import es.com.kete1987.sportmonks.library.v2.model.odds.OddType;
import es.com.kete1987.sportmonks.library.v2.model.odds.OddsResponse;
import es.com.kete1987.sportmonks.library.v2.model.player.PlayerData;
import es.com.kete1987.sportmonks.library.v2.model.rounds.Round;
import es.com.kete1987.sportmonks.library.v2.model.rounds.RoundData;
import es.com.kete1987.sportmonks.library.v2.model.rounds.RoundDataList;
import es.com.kete1987.sportmonks.library.v2.model.season.SeasonData;
...
import es.com.kete1987.sportmonks.library.v2.model.standings.StandingTeam;
import es.com.kete1987.sportmonks.library.v2.model.standings.StandingsData;
import es.com.kete1987.sportmonks.library.v2.model.standings.StandingsDataInfo;
...
import es.com.kete1987.sportmonks.library.v2.model.team.TeamsResponse;
import es.com.kete1987.sportmonks.library.v2.model.topscorers.TopScores;
import es.com.kete1987.sportmonks.library.v2.model.topscorers.TopScoresPlayer;
import es.com.kete1987.sportmonks.library.v2.model.venue.Venue;
import es.com.kete1987.sportmonks.library.v2.model.venue.VenueDetail;
 ...
 * Singleton class
 */
public class SportMonksAPIV2 {
    private static SportMonksAPIV2 instance;
    private String apiKey = null;
    private String headerPending = null;
    private String headerTotal = null;

    private SportMonksAPIV2(String api) {
        apiKey = api;
    }

    public static SportMonksAPIV2 getInstance(String api) {
        if (instance == null) {
            instance = new SportMonksAPIV2(api);
            return instance;
    ...
    public MatchDetail getMatchDetail(String matchId, String... includes) throws IOException, SportMonksException {
        String url = Constants.baseURLV2 + "fixtures/" + matchId + "?api_token=" + apiKey + getIncludes(includes);
        GetResponse response = HttpFunctions.get(url);
        updateHeaders(response);
        if (response.getResponseCode() == Constants.RESPONSE_OK) {
