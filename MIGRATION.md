...
This minor release intentionally includes a **source-incompatible change for
Kotlin** as an exception to strict semantic versioning: these properties now have nullable
